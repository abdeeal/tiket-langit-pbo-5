...
<div class="max-w-7xl mx-auto pt-[5rem] px-4">
  <h2 class="text-2xl font-bold text-gray-900 mb-6">Explore All Around The World</h2>
    ...
    <div class="flex bg-white shadow rounded overflow-hidden ">
      ...
      <div class="p-4 grid grid-cols-5 justify-between flex-grow">
        <div class="col-span-3 mr-4 flex flex-col justify-between">
          <h3 class="font-semibold text-xl text-gray-800 mb-2"><%= name %></h3>
          <p class="text-sm line-clamp-3 text-gray-700"><%= desc %></p>
        ...
        <div class="col-span-2 flex flex-col justify-between">
          ...
          <a href="./trip.jsp?id=<%= id_trip %>" class="bg-blue-900 text-white px-4 py-1 rounded text-center">Book</a>
        </div>
      </div>
    </div>
